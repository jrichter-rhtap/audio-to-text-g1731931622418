...
3) Access the `workbench` named `audio-to-text-g1731931622418-notebook`.
...
5) In the terminal, run `cd audio-to-text-g1731931622418` to navigate to your sample app's directory.
